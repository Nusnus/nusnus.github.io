/**
 * Tool actions — native function calling for Grok via the xAI Responses API.
 *
 * The model returns structured tool calls which are mapped to ToolAction
 * objects rendered as buttons below assistant messages.
 */
